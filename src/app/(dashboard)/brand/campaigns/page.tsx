                        ...
                        <table className="w-full text-[13px]">
                            <thead>
                                <tr className="border-b border-[#E2E2E1]">
                                    ...
                                    <th className="text-left font-medium text-[11px] uppercase tracking-wider text-[#9B9B9B] px-4 py-2.5 hidden lg:table-cell">Échéance</th>
                                        ...
                                        >
                                            <td className="px-4 py-2.5 max-w-[320px]">
                                                ...
                                                {campaign.description && (
                                                    <span className="block text-[12px] text-[#9B9B9B] truncate">{campaign.description}</span>
                                                )}
                                            </td>
