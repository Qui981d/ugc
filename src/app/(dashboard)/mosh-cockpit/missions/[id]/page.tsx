    ...
    if (!campaign) {
        return (
            <div className="max-w-5xl mx-auto py-12 text-center">
                <p className="text-[#65676B] font-medium">Mission introuvable</p>
                <Link href="/mosh-cockpit/missions" className="text-sm text-[#8A8D91] hover:text-[#1C1E21] mt-2 inline-block">← Retour aux missions</Link>
            </div>
        )
    }
        ...
        <div className="max-w-5xl mx-auto space-y-6">
            ...
            {actionError && (
                <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
                    className="fixed top-4 right-4 z-50 bg-red-500 text-white px-4 py-3 rounded-lg shadow-lg flex items-center gap-2 max-w-sm"
                >
            ...
            <div className="flex items-center gap-2 text-sm text-[#8A8D91]">
                <Link href="/mosh-cockpit/missions" className="hover:text-[#1C1E21] transition-colors flex items-center gap-1">
            ...
            {/* Title & Meta */}
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                <h1 className="text-3xl font-bold text-[#1C1E21] tracking-tight">{campaign.title}</h1>
                <div className="flex items-center gap-4 mt-2 text-sm text-[#8A8D91]">
            ...
            >
                <h2 className="text-sm font-semibold text-[#1C1E21] mb-4">Progression du workflow</h2>
                        ...
                        return (
                            <div key={step.type} className="flex items-center flex-1">
                                <div className="flex flex-col items-center w-full">
                                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center mb-2 transition-all ${completed ? 'bg-[#0866FF] text-white' :
                                        isCurrent ? 'bg-[#1C1E21] text-white ring-2 ring-[#0866FF]/40' :
                                            'bg-[#F0F2F5] text-[#BCC0C4]'
                                        }`}>
                                        <StepIcon className="w-4 h-4" strokeWidth={1.5} />
                                    </div>
                                    <p className={`text-[10px] text-center leading-tight ${completed ? 'text-[#1C1E21] font-medium' :
                                ...
                                {i < WORKFLOW_STEPS.length - 1 && (
                                    <div className={`h-0.5 flex-1 mx-1 mt-5 ${completed ? 'bg-[#0866FF]' : 'bg-[#F0F2F5]'}`} />
                                )}
                            </div>
                        )
                    })}
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08 }}
                className="bg-white border border-[#DADDE1] rounded-xl p-6"
            >
                <h2 className="text-sm font-semibold text-[#1C1E21] mb-4 flex items-center gap-2">
                    ...
                    <button
                        ...
                        className="px-3 py-1.5 bg-[#0866FF] text-white text-xs font-medium rounded-lg hover:bg-[#0653CC] transition-all disabled:opacity-50 flex items-center gap-1.5 shadow-sm"
                    >
                ...
                {aiBriefReview && (
                    <div className="mb-4 p-4 bg-[#F0F2F5] border border-[#DADDE1] rounded-lg">
                        <div className="flex items-center gap-2 mb-2">
                            <Sparkles className="w-4 h-4 text-[#1C1E21]" />
                            <p className="text-xs font-semibold text-[#1C1E21]">Analyse IA du brief</p>
                            <div className="flex-1" />
                            <button onClick={() => setAiBriefReview(null)} className="text-[#8A8D91] hover:text-[#1C1E21] text-xs">
                                Fermer
                            </button>
                        </div>
                        <div className="text-sm text-[#1C1E21] whitespace-pre-wrap leading-relaxed">{aiBriefReview}</div>
                    </div>
                )}
                <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                        <p className="text-[#8A8D91] mb-1">Produit</p>
                        <p className="text-[#1C1E21]">{campaign.product_name}</p>
                    </div>
                    <div>
                        <p className="text-[#8A8D91] mb-1">Format</p>
                        <p className="text-[#1C1E21]">{campaign.format}</p>
                    </div>
                    <div>
                        <p className="text-[#8A8D91] mb-1">Type de script</p>
                        <p className="text-[#1C1E21]">{campaign.script_type}</p>
                    </div>
                    <div>
                        <p className="text-[#8A8D91] mb-1">Droits d&apos;usage</p>
                        <p className="text-[#1C1E21]">{campaign.rights_usage}</p>
                    </div>
                    {campaign.description && (
                        <div className="col-span-2">
                            <p className="text-[#8A8D91] mb-1">Description</p>
                            <p className="text-[#1C1E21] whitespace-pre-wrap">{campaign.description}</p>
                        </div>
                    )}
                    {campaign.product_description && (
                        <div className="col-span-2">
                            <p className="text-[#8A8D91] mb-1">Description du produit</p>
                ...
                {!isStepCompleted('brief_received') && (
                    <div className="flex gap-3 mt-4">
                        <button
                            ...
                            className="px-4 py-2 bg-[#0866FF] text-white font-medium rounded-lg hover:bg-[#0653CC] transition-colors disabled:opacity-50 flex items-center gap-2"
                        >
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-[#F0F2F5] text-[#1C1E21] rounded-lg hover:bg-[#EBEDF0] transition-colors flex items-center gap-2"
                        >
                ...
                {showBriefFeedback && (
                    <div className="mt-4 space-y-3">
                        <textarea
                            ...
                            rows={3}
                            className="w-full bg-[#F0F2F5]/50 border border-[#DADDE1] rounded-lg p-4 text-[#1C1E21] text-sm placeholder:text-[#8A8D91] focus:outline-none focus:border-[#0866FF]/50 focus:ring-2 focus:ring-[#0866FF]/20 resize-y"
                        />
                        <button
            ...
            >
                    <h2 className="text-sm font-semibold text-[#1C1E21] mb-4 flex items-center gap-2">
                        <Users className="w-4 h-4 text-[#65676B]" strokeWidth={1.5} />
                        Sélection des créateurs
                    </h2>

                    {campaign.selected_creator ? (
                        <div className="flex items-center gap-4 p-4 bg-[#E7F0FF] border border-[#0866FF]/30 rounded-lg">
                            <div className="w-12 h-12 rounded-lg bg-[#E7F0FF] flex items-center justify-center text-[#1C1E21] font-bold">
                                {campaign.selected_creator.full_name?.[0] || '?'}
                            </div>
                            <div>
                                <p className="text-[#1C1E21] font-medium">{campaign.selected_creator.full_name}</p>
                                <p className="text-[#0653CC] text-sm">Créateur validé ✓</p>
                            </div>
                        </div>
                    ) : showCreatorSelector ? (
                        <div className="space-y-3">
                            <p className="text-sm text-[#65676B]">Sélectionnez 2-3 créateurs à proposer à la marque :</p>
                                ...
                                {creators.map(creator => (
                                    <label
                                        ...
                                        className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all ${selectedCreators.includes(creator.id)
                                            ? 'border-[#0866FF] bg-[#E7F0FF]'
                                            : 'border-[#DADDE1] bg-white/50 hover:bg-[#F0F2F5]'
                                            }`}
                                    >
                                        <input
                                            type="checkbox"
                                            ...
                                            className="sr-only"
                                        />
                                        <div className="w-10 h-10 rounded-lg bg-[#F0F2F5] flex items-center justify-center text-[#1C1E21] font-medium text-sm">
                                            {creator.full_name?.[0] || '?'}
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <p className="text-[#1C1E21] text-sm font-medium truncate">{creator.full_name}</p>
                                            <p className="text-[#8A8D91] text-xs truncate">
                                        ...
                                        {selectedCreators.includes(creator.id) && (
                                            <CheckCircle2 className="w-5 h-5 text-[#0866FF] shrink-0" strokeWidth={1.5} />
                                        )}
                                    </label>
                                ))}
                            </div>
                            <div className="flex gap-3 pt-2">
                                <button
                                    ...
                                    className="px-4 py-2 bg-[#0866FF] text-white font-medium rounded-lg hover:bg-[#0653CC] transition-colors disabled:opacity-50"
                                >
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-[#F0F2F5] text-[#1C1E21] rounded-lg hover:bg-[#EBEDF0] transition-colors"
                                >
                                    Annuler
                                </button>
                            </div>
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-[#0866FF] text-white font-medium rounded-lg hover:bg-[#0653CC] transition-colors"
                        >
                ...
                isStepCompleted('brand_reviewing_profiles') && !isStepCompleted('creator_validated') ? (
                    ...
                    >
                        <h2 className="text-sm font-semibold text-[#1C1E21] mb-3 flex items-center gap-2">
                            <Pencil className="w-4 h-4 text-[#65676B]" strokeWidth={1.5} />
                            Script
                        </h2>
                    ...
                    >
                        ...
                        <textarea
                            ...
                            className="w-full bg-[#F0F2F5]/50 border border-[#DADDE1] rounded-lg p-4 text-[#1C1E21] text-sm placeholder:text-[#8A8D91] focus:outline-none focus:border-[#0866FF]/50 focus:ring-2 focus:ring-[#0866FF]/20 resize-y disabled:opacity-50"
                        />
                        {campaign.script_status !== 'brand_review' && campaign.script_status !== 'brand_approved' && (
                            <div className="flex flex-wrap gap-3 mt-3">
                                <button
                                    ...
                                    className="px-4 py-2 bg-[#0866FF] text-white font-medium rounded-lg hover:bg-[#0653CC] transition-all disabled:opacity-50 flex items-center gap-2"
                                >
                                ...
                                <button
                                    ...
                                    disabled={actionLoading}
                                    className="px-4 py-2 bg-[#F0F2F5] text-[#1C1E21] rounded-lg hover:bg-[#EBEDF0] transition-colors disabled:opacity-50"
                                >
            ...
            {(() => {
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.13 }}
                    className="bg-[#E7F0FF] border-2 border-[#0866FF]/40 rounded-xl p-6"
                >
                    <h2 className="text-sm font-semibold text-[#1C1E21] mb-2 flex items-center gap-2">
                        <ScrollText className="w-4 h-4 text-[#1C1E21]" strokeWidth={1.5} />
                        Préparer & envoyer au{(() => {
                                ...
                                <div className="space-y-3 mb-4">
                                        ...
                                        return (
                                            <div key={cId} className="flex items-center gap-3 bg-white/60 rounded-lg p-3">
                                                ...
                                                <div className="relative w-40">
                                                    <Banknote className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#8A8D91]" strokeWidth={1.5} />
                                                    <input
                                                        type="number"
                                                        value={perCreatorAmounts[cId] || ''}
                                                        onChange={(e) => setPerCreatorAmounts(prev => ({ ...prev, [cId]: e.target.value }))}
                                                        placeholder="CHF"
                                                        className="w-full pl-10 pr-12 py-2 bg-white/80 border border-[#DADDE1] rounded-lg text-[#1C1E21] text-sm placeholder:text-[#8A8D91] focus:outline-none focus:border-[#0866FF]/50 focus:ring-2 focus:ring-[#0866FF]/20"
                                                    />
                                                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-[#8A8D91]">CHF</span>
                                                </div>
                                            </div>
                                        )
                                    })}
                                    {Object.keys(perCreatorAmounts).length > 0 && (
                                        <p className="text-xs text-[#65676B] text-right">
                                            Total : <strong className="text-[#1C1E21]">
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                <div className="relative flex-1 max-w-xs">
                                    ...
                                    <input
                                        ...
                                        placeholder="Ex: 300"
                                        className="w-full pl-10 pr-16 py-3 bg-white/80 border border-[#DADDE1] rounded-lg text-[#1C1E21] placeholder:text-[#8A8D91] focus:outline-none focus:border-[#0866FF]/50 focus:ring-2 focus:ring-[#0866FF]/20"
                                    />
                                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-[#8A8D91]">CHF</span>
                                </div>
                            </div>
                        )
                    })()}
                    ...
                    <button
                        ...
                        className="px-5 py-2.5 bg-[#0866FF] text-white font-medium rounded-lg hover:bg-[#0653CC] transition-colors disabled:opacity-50 flex items-center gap-2"
                    >
            ...
            {(campaign.selected_creator || campaignContents.some(c => (c as any).contract_status)) && campaign.contract_mosh_status && (
                ...
                >
                    <h2 className="text-sm font-semibold text-[#1C1E21] mb-4 flex items-center gap-2">
                        <ScrollText className="w-4 h-4 text-[#65676B]" strokeWidth={1.5} />
                        Contrat MOSH ↔ Créateur
                        {campaign.contract_mosh_status === 'active' && (
                            <span className="text-xs bg-[#E7F0FF] text-[#1C1E21] px-2 py-0.5 rounded-full font-medium">Signé ✓</span>
                        )}
                    ...
                    <div className="space-y-3">
                        <div className="flex flex-wrap items-center gap-4 text-sm text-[#65676B]">
                            <span>Montant créateur : <strong className="text-[#1C1E21]">CHF {campaign.creator_amount_chf?.toLocaleString('fr-CH')}</strong></span>
                            ...
                            {campaign.contract_mosh_signed_at && (
                                <span className="text-[#1C1E21] font-medium">Signé le {new Date(campaign.contract_mosh_signed_at).toLocaleDateString('fr-CH')}</span>
                            )}
                        </div>
                        ...
                        {campaign.creator_price_status === 'counter' && campaign.contract_mosh_status === 'pending_creator' && (
                            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                                ...
                                <button
                                    ...
                                    disabled={actionLoading}
                                    className="px-4 py-2 bg-[#0866FF] text-white rounded-lg text-sm font-medium hover:bg-[#0653CC] transition-colors disabled:opacity-50"
                                >
            ...
            {/* Contract Preview Modal */}
            {
                showContractPreview && contractText && (
                    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setShowContractPreview(false)}>
                        <div className="bg-[#F7F8FA] border border-[#DADDE1] rounded-xl w-full max-w-2xl max-h-[80vh] overflow-hidden flex flex-col" onClick={e => e.stopPropagation()}>
                            <div className="flex items-center justify-between p-5 border-b border-[#DADDE1]">
                                <h3 className="text-sm font-bold text-[#1C1E21] flex items-center gap-2">
                                    <ScrollText className="w-4 h-4 text-[#65676B]" strokeWidth={1.5} /> Contrat de mandat
                                </h3>
                                <button onClick={() => setShowContractPreview(false)} className="text-[#8A8D91] hover:text-[#1C1E21] transition-colors">✕</button>
                            </div>
                            <div className="flex-1 overflow-y-auto p-5">
                                <pre className="text-xs text-[#65676B] whitespace-pre-wrap font-mono leading-relaxed">{contractText}</pre>
                            </div>
                        </div>
                    </div>
                )
                ...
                >
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="w-24 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                                <div
                                    className="h-full bg-[#0866FF] rounded-full transition-all"
                    ...
                    <div className="space-y-2">
                        {campaignContents.map((content, idx) => {
                            ...
                            return (
                                <div key={content.id} className={`border rounded-lg overflow-hidden transition-all ${isExpanded ? 'border-[#1C1E21]/20 shadow-sm' : 'border-[#DADDE1]'}`}>
                                    ...
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-[#F0F2F5] flex items-center justify-center shrink-0">
                                            <ContentIcon className="w-4 h-4 text-[#65676B]" strokeWidth={1.5} />
                                        </div>
                                        ...
                                        {isExpanded ? <ChevronDown className="w-4 h-4 text-[#8A8D91] shrink-0" /> : <ChevronRight className="w-4 h-4 text-[#8A8D91] shrink-0" />}
                                    </button>

                                    {/* Expanded panel */}
                                    {isExpanded && (
                                        <div className="border-t border-[#DADDE1] p-4 space-y-4 bg-[#F7F8FA]">
                                            {/* ── Per-content creator assignment (multi-video only) ── */}
                                            {isMultiContent && (
                                                <div>
                                                    <label className="text-xs text-[#8A8D91] mb-1.5 block flex items-center gap-1.5">
                                                        <Users className="w-3.5 h-3.5" strokeWidth={1.5} />
                                                        Créateur assigné
                                                    </label>
                                                    {assignedCreator ? (
                                                        <div className={`p-3 rounded-lg border ${content.creator_status === 'brand_approved'
                                                            ? 'bg-[#E7F0FF] border-[#0866FF]/30'
                                                            ...
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <div className="flex-1">
                                                                    <p className="text-sm font-medium text-[#1C1E21]">{assignedCreator.full_name}</p>
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="text-xs text-[#8A8D91] hover:text-red-500 transition-colors"
                                                                >
                                                                    Changer
                                                                </button>
                                                            </div>
                                                        ...
                                                        <select
                                                            ...
                                                            className="w-full px-3 py-2 bg-white border border-[#DADDE1] rounded-lg text-sm text-[#1C1E21] focus:outline-none focus:ring-2 focus:ring-[#0866FF]/30"
                                                        >
                                            ...
                                            {(isMultiContent && (!assignedCreator || content.creator_status !== 'brand_approved')) ? (
                                                ...
                                                <div>
                                                    <label className="text-xs text-[#8A8D91] mb-1.5 block">Script</label>
                                                    <textarea
                                                        ...
                                                        rows={5}
                                                        className="w-full px-3 py-2 bg-white border border-[#DADDE1] rounded-lg text-sm placeholder:text-[#8A8D91] focus:outline-none focus:ring-2 focus:ring-[#0866FF]/30 resize-none"
                                                    />
                                                    <div className="flex flex-wrap gap-2 mt-2">
                                                        <button
                                                            ...
                                                            className="px-3 py-1.5 bg-[#F0F2F5] text-[#1C1E21] text-xs font-medium rounded-lg hover:bg-[#EBEDF0] transition-colors"
                                                        >
                                                        ...
                                                        <button
                                                            ...
                                                            className="px-3 py-1.5 bg-[#0866FF] text-white text-xs font-medium rounded-lg hover:bg-[#0653CC] transition-colors disabled:opacity-50 flex items-center gap-1.5"
                                                        >
                                                        ...
                                                        <button
                                                            ...
                                                            disabled={aiLoading === 'script'}
                                                            className="px-3 py-1.5 bg-[#1C1E21] text-white text-xs font-medium rounded-lg hover:bg-[#1C1E21] transition-colors disabled:opacity-50 flex items-center gap-1.5"
                                                        >
                                            ...
                                            {content.video_url && (
                                                <div>
                                                    <label className="text-xs text-[#8A8D91] mb-1.5 block">Vidéo</label>
                                            ...
                                            {content.description && (
                                                <div>
                                                    <label className="text-xs text-[#8A8D91] mb-1 block">Description</label>
                                                    <p className="text-sm text-[#1C1E21]">{content.description}</p>
                                                </div>
                                            )}
            ...
            >
                ...
                {!isStepCompleted('video_uploaded_by_creator') ? (
                    <div className="text-[#8A8D91] text-sm py-4">
                        En attente de la livraison du créateur...
                    </div>
                ) : !isStepCompleted('video_validated') ? (
                    <div className="space-y-4">
                        <p className="text-[#1C1E21] text-sm font-medium flex items-center gap-1.5">
                            <CheckCircle2 className="w-4 h-4 text-[#0866FF]" strokeWidth={1.5} />
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                disabled={actionLoading}
                                className="flex-1 px-4 py-2.5 bg-[#0866FF] text-white font-medium rounded-lg hover:bg-[#0653CC] transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                            >
                        ...
                        {showQcFeedback && (
                            <div className="space-y-3 bg-amber-50 border border-amber-200 rounded-lg p-4">
                                <textarea
                                    ...
                                    rows={3}
                                    className="w-full px-3 py-2 bg-white border border-amber-200 rounded-lg text-sm placeholder:text-[#8A8D91] focus:outline-none focus:border-amber-400"
                                />
                                <button
                    ...
                    >
                        <h2 className="text-sm font-semibold text-[#1C1E21] mb-4 flex items-center gap-2">
                            ...
                            {campaign.invoice_number && (
                                <span className="text-xs bg-[#E7F0FF] text-[#1C1E21] px-2 py-0.5 rounded-full font-medium">{campaign.invoice_number}</span>
                            )}
                        </h2>
                        ...
                        {campaign.invoice_number ? (
                            <div className="space-y-3">
                                <div className="flex items-center gap-4 text-sm text-[#65676B]">
                                    <span>Montant : <strong className="text-[#1C1E21]">CHF {campaign.creator_amount_chf?.toLocaleString('fr-CH')}</strong></span>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-2 bg-[#0866FF] text-white font-medium rounded-lg hover:bg-[#0653CC] transition-colors flex items-center gap-2"
                                    >
                                        <Download className="w-4 h-4" strokeWidth={1.5} />
                                        Télécharger PDF
                                    </button>
                            ...
                            <div className="space-y-3">
                                <p className="text-sm text-[#65676B]">La mission est terminée. Générez la facture pour le créateur.</p>
                                <button
                ...
                showInvoicePreview && invoiceText && (
                    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setShowInvoicePreview(false)}>
                        <div className="bg-[#F7F8FA] border border-[#DADDE1] rounded-xl w-full max-w-2xl max-h-[80vh] overflow-hidden flex flex-col" onClick={e => e.stopPropagation()}>
                            <div className="flex items-center justify-between p-5 border-b border-[#DADDE1]">
                                <h3 className="text-sm font-bold text-[#1C1E21] flex items-center gap-2">
                                    <Receipt className="w-4 h-4 text-[#65676B]" strokeWidth={1.5} /> Facture {campaign?.invoice_number || ''}
                                </h3>
                                <div className="flex items-center gap-2">
                                    <button
                                        onClick={async () => {
                                        ...
                                        className="px-3 py-1.5 bg-[#0866FF] text-white text-xs font-medium rounded-lg hover:bg-[#0653CC] transition-colors flex items-center gap-1.5"
                                    >
                                        <Download className="w-3.5 h-3.5" strokeWidth={1.5} />
                                        Télécharger
                                    </button>
                                    <button onClick={() => setShowInvoicePreview(false)} className="text-[#8A8D91] hover:text-[#1C1E21] transition-colors">✕</button>
                                </div>
                            </div>
                            <div className="flex-1 overflow-y-auto p-5">
                                <pre className="text-xs text-[#65676B] whitespace-pre-wrap font-mono leading-relaxed">{invoiceText}</pre>
                            </div>
                        </div>
                    </div>
                )
            ...
            {campaign.quote_number && (
                ...
                >
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <h3 className="text-sm font-bold text-[#1C1E21]">Devis signé</h3>
                        <span className="text-xs font-mono text-[#65676B] bg-[#F0F2F5] px-2 py-0.5 rounded-full">{campaign.quote_number}</span>
                    </div>
                    <div className="grid grid-cols-3 gap-3 text-xs">
                        <div>
                            <p className="text-[#8A8D91]">Signé le</p>
                            <p className="text-[#1C1E21] font-medium">{campaign.quote_signed_at ? new Date(campaign.quote_signed_at).toLocaleDateString('fr-CH', { day: '2-digit', month: 'short', year: 'numeric', hour: '2-digit', minute: '2-digit' }) : '—'}</p>
                        </div>
                        <div>
                            <p className="text-[#8A8D91]">IP signataire</p>
                            <p className="text-[#1C1E21] font-mono">{campaign.quote_signer_ip || '—'}</p>
                        </div>
                        <div>
                            <p className="text-[#8A8D91]">Offre</p>
                            <p className="text-[#1C1E21] font-medium capitalize">{campaign.pricing_pack || '—'}</p>
                        </div>
                    </div>
                </motion.div>
            )}
            ...
            >
                <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                        ...
                        className="text-xs font-medium text-[#65676B] hover:text-[#1C1E21] transition-colors disabled:opacity-50"
                    >
                ...
                <textarea
                    ...
                    rows={3}
                    className="w-full bg-[#F0F2F5] border border-[#DADDE1] rounded-lg px-4 py-3 text-sm text-[#1C1E21] placeholder:text-[#8A8D91] focus:outline-none focus:ring-2 focus:ring-[#0866FF]/30 focus:border-[#0866FF]/50 resize-none"
                />
            </motion.div>
        </div>
    )
