...
const STATUS_CONFIG: Record<string, { label: string; color: string; bg: string; icon: typeof Clock }> = {
    draft: { label: 'Brief reçu', color: 'text-[#6B6B6B]', bg: 'bg-[#F4F4F3]', icon: FileText },
    open: { label: 'Profils proposés', color: 'text-[#333333]', bg: 'bg-[#EDEDEC]', icon: Users },
    in_progress: { label: 'En production', color: 'text-white', bg: 'bg-[#1A1A1A]', icon: Video },
    completed: { label: 'Terminée', color: 'text-[#1A1A1A]', bg: 'bg-[#1A1A1A]', icon: CheckCircle2 },
    cancelled: { label: 'Annulée', color: 'text-[#9B9B9B]', bg: 'bg-[#F4F4F3]', icon: XCircle },
}
        ...
        <div className="max-w-[1400px] mx-auto">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-3">
                ...
                <select
                    ...
                    className="h-9 px-3 bg-white border border-[#E2E2E1] rounded-lg text-[13px] text-[#1A1A1A] focus:outline-none focus:border-[#1A1A1A] cursor-pointer"
                >
                        ...
                        <table className="w-full text-[13px]">
                            <thead>
                                <tr className="border-b border-[#E2E2E1]">
                                    ...
                                    <th className="text-left font-medium text-[11px] uppercase tracking-wider text-[#9B9B9B] px-4 py-2.5 hidden xl:table-cell">Échéance</th>
                                    <th className="w-8" />
                                </tr>
                            </thead>
